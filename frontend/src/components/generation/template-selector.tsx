...
import { CheckSquare, Edit, FileText, GitCompare, type LucideIcon } from 'lucide-react';
...
export function TemplateSelector({ value, onChange }: TemplateSelectorProps) {
  ...
  return (
    <div className="grid grid-cols-2 gap-4" role="radiogroup" aria-label="Template selection">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                {template.exampleOutput && (
                  <div className="mt-2">
                    <p className="text-xs text-muted-foreground italic">Example preview:</p>
