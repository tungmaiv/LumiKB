...
describe('AddGroupPermissionModal', () => {
  ...
  describe('rendering', () => {
    it('[P1] should render modal with title and description', () => {
      ...
      expect(screen.getByText(/Grant a group access to this Knowledge Base/)).toBeInTheDocument();
    });
    ...
    it('[P1] should exclude groups with existing permissions', () => {
       ...
       */
      render(
        <AddGroupPermissionModal {...defaultProps} existingGroupIds={['group-1', 'group-3']} />
      );
  ...
  describe('search', () => {
    ...
    it('[P2] should show no results message when search finds nothing', async () => {
      ...
      expect(screen.getByText('No groups found matching your search')).toBeInTheDocument();
    });
  });
  ...
  describe('form submission', () => {
    it('[P1] should call onGrantPermission with selected group and level', async () => {
      ...
      render(<AddGroupPermissionModal {...defaultProps} onGrantPermission={onGrantPermission} />);
    ...
    it('[P1] should close modal on successful submission', async () => {
      ...
      render(<AddGroupPermissionModal {...defaultProps} onOpenChange={onOpenChange} />);
