...
test.describe("Audit Log Export", () => {
  ...
  test("should display Export button on Audit Log Viewer page", async ({
    page,
  }) => {
  ...
  test("should open export modal when Export button clicked", async ({
    page,
  }) => {
    // Click Export button
    ...
    await expect(
      page.getByText("JSON (JavaScript Object Notation)")
    ).toBeVisible();
  });

  test("should download CSV file when Download CSV clicked", async ({
    page,
  }) => {
    // Click Export button
    await page.getByRole("button", { name: /export/i }).click();
  ...
  test("should download JSON file when JSON format selected", async ({
    page,
  }) => {
    // Click Export button
    await page.getByRole("button", { name: /export/i }).click();
...
test.describe("Audit Log Export - Non-Admin", () => {
  test("should not display Export button for non-admin users", async ({
    page,
  }) => {
