...
✅ R-001 (TECH): Token limit management - 3 tests
✅ R-002 (SEC): Citation injection - 5 tests
✅ R-003 (PERF): Streaming latency - 2 tests
✅ R-004 (DATA): Export citation preservation - 5 tests
✅ R-005 (BUS): Low-confidence flagging - 6 tests
...
**Documentation:**
8. `docs/atdd-checklist-epic-4.md` (this file)
9. `docs/test-design-epic-4.md` (risk assessment, test plan)
